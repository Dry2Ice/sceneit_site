        ...
        {currentUser?.isAdmin && (
          <div className="flex items-center gap-4 mt-6 pt-6 border-t border-neutral-800/30">
            ...
            <EditModal type="reviews" id={review.id as number} accentColor="#fb7185" fields={[
              ...
              { name: "rating", label: "Rating", type: "number", value: review.rating },
              { name: "genre", label: "Genre", type: "text", value: review.genre },
              { name: "preview", label: "Preview", type: "textarea", value: review.preview },
            ]} />
