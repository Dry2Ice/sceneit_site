    ...
    <main className="relative min-h-screen bg-[#07070a] text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 pt-28 pb-20">
        ...
        <div className="flex items-center gap-2 mb-10 text-[10px] tracking-[0.2em] uppercase text-neutral-500">
          ...
          <span className="opacity-30">/</span>
          <span className="text-violet-400/70">Votes</span>
        </div>
        ...
        <div className="mb-10">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold tracking-tight mb-3">Votes & Polls</h1>
          <p className="text-neutral-500 text-sm">Cast your vote. Shape the community canon.</p>
        </div>
        ...
        <div className="flex items-center gap-1 mb-6 p-1 bg-white/[0.02] rounded-lg w-fit">
          {([
            ...
            { key: "most-voted" as SortKey, label: "Most Voted" },
          ]).map((tab) => (
            <button
              key={tab.key}
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-3 flex items-center gap-1.5 text-[10px] text-violet-400/60">
                      ...
                      Leading: {topOption.label} ({Math.round((topOption.votes / p.totalVotes) * 100)}%)
                    </div>
                  </div>
                </div>
              </div>
        ...
        {filtered.length === 0 && (
          <div className="text-center py-20">
            <p className="text-neutral-600 text-sm">No polls found matching your criteria.</p>
          </div>
        )}
      </div>
    </main>
