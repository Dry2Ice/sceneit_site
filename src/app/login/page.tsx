  ...
  return (
    <main className="relative min-h-screen bg-[#07070a] text-white flex items-center justify-center px-6">
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <p className="text-neutral-500 text-sm mb-8">Welcome back to SceneIt.</p>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="text-[10px] tracking-[0.2em] uppercase text-neutral-500 block mb-1.5">Email</label>
          ...
          <div>
            <label className="text-[10px] tracking-[0.2em] uppercase text-neutral-500 block mb-1.5">Password</label>
            <input name="password" type="password" required className="w-full bg-white/[0.03] border border-neutral-800/50 rounded-lg px-4 py-2.5 text-sm text-white placeholder:text-neutral-600 focus:outline-none focus:border-violet-500/30 transition-colors" placeholder="Your password" />
          </div>
